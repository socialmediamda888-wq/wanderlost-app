...
function init() {
    ...
    btnScan.addEventListener('click', () => {
        ...
        btnScan.innerHTML = '<i class="fa-solid fa-filter fa-spin"></i> Filtering &gt;4.7★ Locations...';
        
        setTimeout(() => {
            btnScan.innerHTML = '<i class="fa-solid fa-language fa-spin"></i> Analyzing Native Reviews...';
